...
\item \textbf{Trugschluss: Keine Fehler bedeutet eine brauchbares System}: Die \glossarmark{Stakeholder} wurden schon bei der \glossarmark{Mockup} Erstellung mit einbezogen und bekamen auch während der Entwicklung immer wieder einen Blick in den aktuellen Stand.
\end{enumerate}
