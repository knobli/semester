...
In diesem Unterkapitel werden neben einem detailierten Aufbau der App, die unterschiedlichen Provisioning Prozesse und das Refactoring des Backends beschrieben. Des Weiteren wird eine Übersicht der Push-Nachricht Implementierung vermittelt.
